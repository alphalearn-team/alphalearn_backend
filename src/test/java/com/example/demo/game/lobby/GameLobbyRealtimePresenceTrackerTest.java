...
class GameLobbyRealtimePresenceTrackerTest {

    private final GameLobbyRealtimePresenceTracker tracker = new GameLobbyRealtimePresenceTracker();
    ...
    void consumesTimeoutAfterGraceWhenSessionStaysDisconnected() {
        ...
        List<GameLobbyRealtimePresenceTracker.DisconnectTimeoutCandidate> beforeGrace =
                tracker.consumeDueDisconnectTimeouts(now.plusSeconds(29));
        List<GameLobbyRealtimePresenceTracker.DisconnectTimeoutCandidate> afterGrace =
    ...
    void listReconnectPresenceReturnsLearnerAndDeadlineWhenReconnectPending() {
        ...
        List<GameLobbyRealtimePresenceTracker.ReconnectPresenceSnapshot> reconnectPresence =
