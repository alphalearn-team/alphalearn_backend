...
public class GameLobby {
    ...
    private GameLobbyConceptPoolMode conceptPoolMode;
    ...
    private Integer gameGuessTimerSeconds;
    ...
    private UUID currentGameLearnerId;

    @Enumerated(EnumType.STRING)
    @Column(name = "current_phase", length = 32)
    private GameLobbyPhase currentPhase;
    ...
    private OffsetDateTime gameGuessDeadlineAt;

    @Column(name = "last_imposter_guess", columnDefinition = "text")
    private String lastGameGuess;

    @Column(name = "last_imposter_guess_correct")
    private Boolean lastGameGuessCorrect;
    ...
    private UUID latestResultGameLearnerId;

    @Column(name = "latest_result_imposter_wins_by_voting_tie")
    private Boolean latestResultGameWinsByVotingTie;

    @Column(name = "latest_result_imposter_guess", columnDefinition = "text")
    private String latestResultGameGuess;
