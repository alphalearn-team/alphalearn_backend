...
import com.example.demo.game.lobby.GameLobbyRealtimePresenceTracker;
...
public class GameLobbyWebSocketPresenceListener {
    ...
    public GameLobbyWebSocketPresenceListener(
    ...
    public void onSubscribe(SessionSubscribeEvent event) {
        ...
        if (clearedReconnectState) {
            learnerGameLobbyService.publishRealtimePresenceUpdate(lobbyPublicId, "RECONNECTED");
        }
    }
    ...
    public void onDisconnect(SessionDisconnectEvent event) {
        ...
        for (UUID lobbyPublicId : lobbiesWithPendingReconnect) {
            learnerGameLobbyService.publishRealtimePresenceUpdate(lobbyPublicId, "RECONNECTING");
        }
    }
