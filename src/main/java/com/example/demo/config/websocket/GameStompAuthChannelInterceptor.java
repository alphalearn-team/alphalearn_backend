...
@Component
public class GameStompAuthChannelInterceptor implements ChannelInterceptor {
    ...
    public GameStompAuthChannelInterceptor(
    ...
    private void authorizeLobbyDestination(StompHeaderAccessor accessor) {
        ...
        GameLobby lobby = lobbyRepository.findByPublicId(lobbyPublicId)
                .orElseThrow(() -> new AccessDeniedException("Game lobby not found"));
