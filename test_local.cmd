...
REM Usage:
REM   test_local.cmd            -> loads .env.shared + .env.local (default)
REM   test_local.cmd production -> loads .env.shared + .env.production
REM
REM Runs backend test suite with layered env files.
